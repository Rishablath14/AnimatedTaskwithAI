  ...
  return (
    ...
    <div className="w-full relative z-10 mx-auto rounded-lg py-6 md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-[#ffffff34]">
      ...
      <form className="" onSubmit={handleSubmit}>
        ...
        <button
          className="bg-gradient-to-br disabled:bg-gray-400 mt-2 relative group/btn hover:-translate-y-1 transition-all  dark:bg-[#ffffff5e] w-full text-black rounded-md h-10 font-medium dark:shadow-[1px_1px_1px_1px_var(--zinc-900)_inset,-1px_-1px_-1px_-1px_var(--zinc-900)_inset]"
          type="submit"
          disabled={loading}
          >
          Sign up &rarr;
        ...
        <p className="text-sm text-white text-center mt-4">Already Registered? <Link to={"/login"} className="font-bold hover:underline">Login</Link></p>
      </form>
    </div>
